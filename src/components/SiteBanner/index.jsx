...
const SiteBanner = ({ bannerLocation }) => {
  return (
   ...
   className={` container px-6 mx-auto ${
    ...
    'mt-40' : 'mt-20 flex flex-col justify-center items-center'
   }`}
   >
    <h2 className="mb-2 text-4xl font-bold text-white">
      {bannerLocation === 'upper'
      ? "Experience Luxury Like Never Before with Mutlu"
    ...
    <button className={`px-8 py-4 font-bold tracking-wider uppercase border-2 shadow-lg ${
      bannerLocation === 'upper' ? 'text-white' : 'text-black bg-white rounded-2xl'
    }`}>
